...
public class FriendsProvider extends ContentProvider{
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        sqLiteQueryBuilder.setTables(FriendsContract.Friends.FRIENDS);
        ...
        switch (match) {
            ...
            case FRIENDS_ID:
                ...
                sqLiteQueryBuilder.appendWhere(FriendsContract.Friends._ID + " = " + id);
                break;
            default:
                throw new IllegalArgumentException("Unknown Uri: " + uri);
        }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match){
            case FRIENDS:
                long recordId = db.insertOrThrow(FriendsContract.Friends.FRIENDS, null, values);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (match){
            ...
            case FRIENDS_ID:
                String id = FriendsContract.Friends.getFriendId(uri);
                selectionCriteria = FriendsContract.Friends._ID + " = " + id
                        + (!TextUtils.isEmpty(selection) ? " AND ( " + selection + " )": "");
                break;
            default:
                throw new IllegalArgumentException("Unknown Uri: " + uri);
        }
        return db.update(FriendsContract.Friends.FRIENDS, values, selectionCriteria, selectionArgs);
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        if (uri.equals(FriendsContract.BASE_CONTENT_URI) || uri.equals(FriendsContract.URI_TABLE)){
            deleteDatabase();
            return 0;
        }
        ...
        switch (match){
            case FRIENDS_ID:
                String id = FriendsContract.Friends.getFriendId(uri);
                String selectionCriteria = FriendsContract.Friends._ID + " = " + id
                        + (!TextUtils.isEmpty(selection) ? " AND ( " + selection + " )": "");
                return db.delete(FriendsContract.Friends.FRIENDS, selectionCriteria, selectionArgs);
            default:
                throw new IllegalArgumentException("Unknown Uri: " + uri);
        }
    }
